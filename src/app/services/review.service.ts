...
export class ReviewService {
  ...
  constructor(rentalService: RentalService) {
    ...
    5, "April 2019");
    let review3 = new Review("Julian", rentalService.getRentals()[2], "The apartment is very nice and comfortable! Location is very convenient, near shops and public transport. (Host Name) was very helpful and friendly, he’s a super host!",
    5, "January 2019");
